        ...
        <?php foreach ($buku as $bk) : ?>
            ...
            <div class="card ml-4 mb-4" style="width: 17rem;">
                ...
                <div class="card-body">
                    ...
                    <?php echo anchor('dashboard/tambah_ke_keranjang/'. $bk->id_buku,'<div class="btn btn-sm btn-info mb-3">Masukan ke Keranjang</div>') ?>
                    <?php echo anchor('dashboard/detail/'. $bk->id_buku,'<div class="btn btn-sm btn-warning">Detail Buku</div>') ?>
